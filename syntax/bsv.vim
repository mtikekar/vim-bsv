...
syntax keyword bsvKeyword module rule function instance interface method rules return action package
syntax keyword bsvKeyword numeric type provisos parameter

syntax keyword bsvScope begin end endmodule endfunction endinterface endcase endinstance endrule endaction endmethod endrules endpackage nextgroup=bsvScopeIdentifier
